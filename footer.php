					...
					<div class="row" style='text-align: center;'>
						...
						<div class="12u">
								<section class="contact">
									<!-- <p>Contact us with following links</p> -->
									<ul class="icons">
										<!-- <li><a href="#" class="fa fa-twitter solo"><span>Twitter</span></a></li> -->
										<li><a href="https://www.facebook.com/KongerehHonar" class="fa fa-facebook solo"><span>Facebook</span></a></li>
										<li><a href="https://plus.google.com/108036940967000440354" class="fa fa-google-plus solo"><span>Google+</span></a></li>
										<!--<li><a href="#" class="fa fa-pinterest solo"><span>Pinterest</span></a></li> -->
										<!-- <li><a href="#" class="fa fa-dribbble solo"><span>Dribbble</span></a></li> -->
										<li><a href="http://www.linkedin.com/pub/mehdi-foroughmand/44/829/a93" class="fa fa-linkedin solo"><span>Linkedin</span></a></li>
									</ul>
								</section>
